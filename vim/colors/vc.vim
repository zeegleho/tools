...
hi Comment		gui=NONE		guifg=#006600		guibg=#AAAAAA  gui=bold
hi Constant		gui=NONE		guifg=#FF0000 		guibg=#AAAAAA  gui=bold
hi Identifier	gui=NONE		guifg=#0000FF		guibg=#AAAAAA	gui=bold
